...
```
bpmn:getDataObject('approved') => ${XML('<emptyRootElement />').xPath("bpmn:getDataObject('approved')").bool()}
not(bpmn:getDataObject('approved')) => ${XML('<emptyRootElement />').xPath("not(bpmn:getDataObject('approved'))").bool()}
